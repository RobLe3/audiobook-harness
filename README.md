...
Current release: **0.5.5**. Audiobook Harness uses one SemVer product identity;
...
Version 0.5.5 executes all eight phases as receipt-last transactions. Each
...
Version 0.5.5 writes source-preserving analysis contracts for structure, spoken
...
Version 0.5.5 also exposes the production contract directly:
