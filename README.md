...
Current release: **0.7.3**. Audiobook Harness uses one SemVer product identity;
...
Version 0.7.3 executes all eight phases as receipt-last transactions. Each
...
Version 0.7.3 writes source-preserving analysis contracts for structure, spoken
...
Version 0.7.3 also exposes the production contract directly:
