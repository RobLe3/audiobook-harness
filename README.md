...
Current release: **0.5.8**. Audiobook Harness uses one SemVer product identity;
...
Version 0.5.8 executes all eight phases as receipt-last transactions. Each
...
Version 0.5.8 writes source-preserving analysis contracts for structure, spoken
...
Version 0.5.8 also exposes the production contract directly:
