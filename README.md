...
Current release: **0.7.4**. Audiobook Harness uses one SemVer product identity;
...
Terminal repair results are evidence-bound: the Review Center will not relaunch
the same exhausted work until a review decision or other bound input changes.
...
Version 0.7.4 executes all eight phases as receipt-last transactions. Each
...
Version 0.7.4 writes source-preserving analysis contracts for structure, spoken
...
Version 0.7.4 also exposes the production contract directly:
