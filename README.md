...
Current release: **0.7.1**. Audiobook Harness uses one SemVer product identity;
...
Version 0.7.1 executes all eight phases as receipt-last transactions. Each
...
Version 0.7.1 writes source-preserving analysis contracts for structure, spoken
...
Version 0.7.1 also exposes the production contract directly:
