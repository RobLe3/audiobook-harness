...
Audiobook Harness **0.5.8** is the current product release. It adds
...
The supported maturity claim for 0.5.8 is controlled maintainer-operated local
...
product versions. New reports identify the product as `0.5.8` and bind the
