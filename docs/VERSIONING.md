...
Audiobook Harness **0.7.2** is the current product release. It hardens the
...
The supported maturity claim for 0.7.2 is controlled maintainer-operated local
...
product versions. New reports identify the product as `0.7.2` and bind the
