...
Audiobook Harness **0.4.11** is the current product release. It adds an
...
remain mandatory.
Version 0.4.11 also binds repair tickets to implementation identity, permits one
fresh bounded attempt after a tested harness correction, and makes reviewed
phoneme replacement idempotent without weakening pronunciation authority.
...
product versions. New reports identify the product as `0.4.11` and bind the
