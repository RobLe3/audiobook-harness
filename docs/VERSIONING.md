...
Audiobook Harness **0.7.5** is the current product release. It hardens the
...
The supported maturity claim for 0.7.5 is controlled maintainer-operated local
...
product versions. New reports identify the product as `0.7.5` and bind the
